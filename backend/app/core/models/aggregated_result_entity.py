...
class AggregatedResultEntity(BaseModel):
    ...
    id: UUID | None = Field(
        ...
        examples=["124d925b-f2af-4691-888b-db9a8f0531f2"],
    )

    weighted_score: float = Field(default=-1.0, description="The weighted score of the evaluation", examples=[0.845])
    ...
    created_at: datetime | None = Field(
        ...
        examples=["2026-04-22 12:00:13.238855"],
    )
