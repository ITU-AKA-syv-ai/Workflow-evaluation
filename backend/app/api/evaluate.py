...
async def evaluate_endpoint(
    ...
    for req in requests:
        ...
        try:
            result_id = repo.insert(entity)  # todo: this is currently the first time we get the aggregated result id - it is currently generated by insertion into the database, as it is the default value
