    ...
    for req in requests:
        ...
        try:
            job_id = result_repo.insert(
                entity
            )  # todo: this is currently the first time we get the aggregated result id - it is currently generated by insertion into the database, as it is the default value
